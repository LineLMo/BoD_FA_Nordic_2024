...
c(mean((DK_YLD_PA+YLL_PA_DK)/DKInc_PA), quantile((DK_YLD_PA+YLL_PA_DK)/DKInc_PA, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#3.242910 2.530889 4.009513         #Peanuts in Denmark pr case
...
c(mean((DK_YLD_TN+YLL_TN_DK)/DKInc_TN), quantile((DK_YLD_TN+YLL_TN_DK)/DKInc_TN, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.108813 3.870996 6.529770       #Nuts in Denmark per case
...
c(mean((DK_YLD_TNW+YLL_TN_DK)/DKInc_TNW), quantile((DK_YLD_TNW+YLL_TN_DK)/DKInc_TNW, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.102953 3.864777 6.525672        #Worst case Treenuts in Denmark per case
...
c(mean((DK_YLD_CM+YLL_CM_DK)/DKInc_CM), quantile((DK_YLD_CM+YLL_CM_DK)/DKInc_CM, probs = c(0.025, 0.975)))
#               2.5%     97.5% 
#1.1684329 0.7280513 1.7455744    #Milk in Denmark pr case
...
c(mean((SE_YLD_PA+YLL_PA_SE)/SEInc_PA), quantile((SE_YLD_PA+YLL_PA_SE)/SEInc_PA, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#3.304118 2.579467 4.086447    #Peanuts in Sweden pr case
...
c(mean((SE_YLD_TN+YLL_TN_SE)/SEInc_TN), quantile((SE_YLD_TN+YLL_TN_SE)/SEInc_TN, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.204581 3.943300 6.651687     #Treenuts in Sweden pr case
...
c(mean((SE_YLD_TNW+YLL_TN_SE)/SEInc_TNW), quantile((SE_YLD_TNW+YLL_TN_SE)/SEInc_TNW, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.202366 3.939772 6.645232       #Worst case Tree nuts in Sweden pr case
...
c(mean((SE_YLD_CM+YLL_CM_SE)/SEInc_CM), quantile((SE_YLD_CM+YLL_CM_SE)/SEInc_CM, probs = c(0.025, 0.975)))
#               2.5%     97.5% 
#1.1822041 0.7375124 1.7687397    #Milk in Sweden pr case
...
c(mean((NO_YLD_PA+YLL_PA_NO)/NOInc_PA), quantile((NO_YLD_PA+YLL_PA_NO)/NOInc_PA, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#3.309788 2.583054 4.094279      #PA in Norway pr case
...
c(mean((NO_YLD_TN+YLL_TN_NO)/NOInc_TN), quantile((NO_YLD_TN+YLL_TN_NO)/NOInc_TN, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.206233 3.943508 6.656705     #Treenuts in Norway pr case
...
c(mean((NO_YLD_CM+YLL_CM_NO)/NOInc_CM), quantile((NO_YLD_CM+YLL_CM_NO)/NOInc_CM, probs = c(0.025, 0.975)))
#               2.5%     97.5% 
#1.1767314 0.7345707 1.7589444     #Milk in Norway pr case
...
c(mean((FI_YLD_PA+YLL_PA_FI)/FIInc_PA), quantile((FI_YLD_PA+YLL_PA_FI)/FIInc_PA, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#3.216365 2.506672 3.979036           #Peanuts in Finland pr case
...
c(mean((FI_YLD_TN+YLL_TN_FI)/FIInc_TN), quantile((FI_YLD_TN+YLL_TN_FI)/FIInc_TN, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.098496 3.864830 6.516851      #Treenuts in Finland pr case
...
c(mean((FI_YLD_CM+YLL_CM_FI)/FIInc_CM), quantile((FI_YLD_CM+YLL_CM_FI)/FIInc_CM, probs = c(0.025, 0.975)))
#               2.5%     97.5% 
#1.1613454 0.7249462 1.7355795     #Milk in Finland pr case
...
c(mean((IC_YLD_PA+YLL_PA_IC)/ICInc_PA), quantile((IC_YLD_PA+YLL_PA_IC)/ICInc_PA, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#3.268648 2.399295 4.270622     #Peanuts in Iceland pr case
...
c(mean((IC_YLD_TN+YLL_TN_IC)/ICInc_TN), quantile((IC_YLD_TN+YLL_TN_IC)/ICInc_TN, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.707912 3.964277 7.868286    #Treenuts in Iceland pr case
...
c(mean((IC_YLD_TNW+YLL_TN_IC)/ICInc_TNW), quantile((IC_YLD_TNW+YLL_TN_IC)/ICInc_TNW, probs = c(0.025, 0.975)))
#             2.5%    97.5% 
#5.569526 3.963117 7.518275      #Worst case Treenuts in Denmark pr case
...
c(mean((IC_YLD_CM+YLL_CM_IC)/ICInc_CM), quantile((IC_YLD_CM+YLL_CM_IC)/ICInc_CM, probs = c(0.025, 0.975)))
#               2.5%     97.5% 
#1.1903882 0.6909508 1.8227652      #Milk in Iceland pr case
